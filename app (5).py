...
with demo:
    ...
    chatbot = gr.ChatInterface(
        respond,
        examples=[
            ["What is freeway and non free way"],
            ["explain about partial lane shifts"],
            ["what to do in case of line closures or line occupancy cases?"],
            ["What are ingress and egress work zone in relation to traffic?"],
            ["what to consider in anti glare scrrening on freeway?"],
        ],
        title='Traffic rules'
    )
